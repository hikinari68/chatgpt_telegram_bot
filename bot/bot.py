...
async def generate_image_handle(update: Update, context: CallbackContext, message=None):
    ...
    # usage accounting
    db.set_user_attribute(user_id, "n_generated_images", len(
...
def run_bot() -> None:
    ...
    application.add_handler(MessageHandler(
        filters.PHOTO & ~filters.COMMAND & user_filter, message_handle))
    application.add_handler(MessageHandler(
        filters.VIDEO & ~filters.COMMAND & user_filter, unsupport_message_handle))
    application.add_handler(MessageHandler(
        filters.Document.ALL & ~filters.COMMAND & user_filter, unsupport_message_handle))
    application.add_handler(CommandHandler(
